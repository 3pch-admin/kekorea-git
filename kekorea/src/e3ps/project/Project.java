...
@GenAsPersistable(superClass = WTObject.class, interfaces = { ContentHolder.class, ProjectImpl.class },
		...
		properties = {
				...
				@GeneratedProperty(name = "kekNumber", type = String.class, javaDoc = "KEK 작번", constraints = @PropertyConstraints(required = true), columnProperties = @ColumnProperties(index = true)),

				@GeneratedProperty(name = "pDate", type = Timestamp.class, javaDoc = "작번 발행일", constraints = @PropertyConstraints(required = true), columnProperties = @ColumnProperties(index = true)),
				...
				@GeneratedProperty(name = "pType", type = String.class)
