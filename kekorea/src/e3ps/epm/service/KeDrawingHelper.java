...
public class KeDrawingHelper {
	...
	public Map<String, Object> list(Map<String, Object> params) throws Exception {
		...
		if (keNumber != null) {
			if (!keNumber.isEmpty()) {
				String[] aa = keNumber.split(",");
				ArrayList<String> kekNumbersUpper = new ArrayList();
				for (String kekNumber : aa) {
					kekNumbersUpper.add(kekNumber.toUpperCase());
				}
				QuerySpecUtils.toIn(query, idx_m, KeDrawingMaster.class, KeDrawingMaster.KE_NUMBER, kekNumbersUpper);
			}

		}

		// QuerySpecUtils.toLikeAnd(query, idx_m, KeDrawingMaster.class,
		// KeDrawingMaster.KE_NUMBER, keNumber);
		...
		System.out.println("###kedrawing list query==" + query.toString());

		PageQueryUtils pager = new PageQueryUtils(params, query);
		PagingQueryResult result = pager.find();

		System.out.println("###kedrawing list result==" + result.size());
