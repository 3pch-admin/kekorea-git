...
public class NumberRuleDTO {
	...
	public NumberRuleDTO(NumberRule numberRule) throws Exception {
		...
		if (numberRule.getMaster().getSector() != null) {
		...
		if (numberRule.getMaster().getCompany() != null) {
		...
		if (numberRule.getMaster().getDepartment() != null) {
		...
		if (numberRule.getMaster().getDocument() != null) {
		...
		if (numberRule.getMaster().getSize() != null) {
		...
		setCreatedDate_txt(CommonUtils.getPersistableTime(numberRule.getMaster().getCreateTime()));
		setModifierId(numberRule.getOwnership().getOwner().getName());
		setModifier(numberRule.getOwnership().getOwner().getFullName());
		setModifiedDate_txt(CommonUtils.getPersistableTime(numberRule.getModifyTime()));
	}
}
