...
// 최초등록자
		properties = {
				...
				@GeneratedProperty(name = "lotNo", type = Integer.class, javaDoc = "LOT", constraints = @PropertyConstraints(required = false)),

				@GeneratedProperty(name = "unitName", type = String.class, javaDoc = "UNIT NAME", constraints = @PropertyConstraints(required = false)),

				@GeneratedProperty(name = "createTime", type = Timestamp.class, javaDoc = "", constraints = @PropertyConstraints(required = true)),
				
				@GeneratedProperty(name = "modifyTime", type = Timestamp.class, javaDoc = "", constraints = @PropertyConstraints(required = true)),
