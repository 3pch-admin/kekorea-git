...
public class NumberRuleHelper {
	...
	public Map<String, Object> list(Map<String, Object> params) throws Exception {
		...
		QuerySpecUtils.toTimeGreaterAndLess(query, idx, NumberRule.class, NumberRule.CREATE_TIME, createdFrom,
				createdTo);
		...
		QuerySpecUtils.toOrderBy(query, idx, NumberRule.class, NumberRule.CREATE_TIME, true);
	 ...
	 */
	public synchronized Map<String, Object> last(String number) throws Exception {
