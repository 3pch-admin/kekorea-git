...
public class TBOMMasterDTO {
	...
	public TBOMMasterDTO(TBOMMaster master) throws Exception {
		...
		QueryResult qr2= PersistenceHelper.manager.navigate(master, "project", TBOMMasterProjectLink.class);
		String reKekNumber = "";
		String reKeNumber = "";
	...
	public TBOMMasterDTO(TBOMMaster master, Project project) throws Exception {
		setOid(master.getPersistInfo().getObjectIdentifier().getStringValue());
