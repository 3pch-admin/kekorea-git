...
@GenAsPersistable(superClass = WTObject.class,
		...
		properties = {
				...
				@GeneratedProperty(name = "category_code", type = String.class, javaDoc = "category_code"),
				@GeneratedProperty(name = "category_name", type = String.class, javaDoc = "category_name"),
				
				@GeneratedProperty(name = "item_code", type = String.class, javaDoc = "item_code"),
				@GeneratedProperty(name = "item_name", type = String.class, javaDoc = "item_name"),
