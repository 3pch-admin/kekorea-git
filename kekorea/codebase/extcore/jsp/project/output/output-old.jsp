		...
		<table class="button-table">
			<tr>
				<td class="left">
					...
					<input type="button" value="NEW" title="NEW" onclick="toggle();" style="background-color: orange;">
				</td>
				<td class="right">
				...
				return [ {
					...
					renderer : {
						...
						jsCallback : function(rowIndex, columnIndex, value, item) {
							const oid = item.oid;
							const url = getCallUrl("/output/view?oid=" + oid + "&tProg=0");
							popup(url, 1600, 800);
						}
					},
					filter : {
...
// 					vScrollChangeHandler(event);
			...
			function loadGridData() {
				...
				const url = getCallUrl("/output/old");
				const field =["oid","name","number","content","kekNumber","keNumber","description"
									,"creatorOid","createdFrom","createdTo","state","type","mak"];
...
// 				parent.openLayer();
			...
			function exportExcel() {
				...
				exportToExcel("산출물 OLD 리스트", "산출물 OLD", "산출물 OLD 리스트", exceptColumnFields, sessionName);
			}
