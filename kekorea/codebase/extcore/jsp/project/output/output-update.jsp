...
String funtionTitle = mode+"s";
System.out.println(request.getAttribute("dto")+" : $$$$$$$$$$$$$$$$$$$$$$$$$$ : "+dto.getLocation());
%>
<%@include file="/extcore/jsp/common/aui/auigrid.jsp"%>
<input type="hidden" name="oid" id="oid" value="<%=dto.getOid() %>">
<input type="hidden" name="tProg" id="tProg" value="<%=dto.getProgress() %>">
<table class="button-table">
	<tr>
		...
		<td class="right">
			<input type="button" value="<%=title%>" title="<%=title%>" onclick="<%=funtionTitle%>();">
...
<table class="create-table">
	...
	<tr>
		...
		<th>진행율</th>
		<td class="indent5">
			<input type="number" name="progress" id="progress" class="width-300" value="<%=dto.getProgress() %>" maxlength="3">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="indent5" colspan="3">
			<jsp:include page="/extcore/jsp/common/attach-primary.jsp">
				<jsp:param value="<%=dto.getOid() %>" name="oid" />
				<jsp:param value="update" name="cmd" />
			</jsp:include>
		</td>
	</tr>
	<tr>
