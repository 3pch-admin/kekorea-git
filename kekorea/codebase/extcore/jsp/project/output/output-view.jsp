...
Persistable d = (Persistable) CommonUtils.getObject(dto.getOid());
// out.println(d instanceof E3PSDocument);
...
<script type="text/javascript">
	function update(mode) {
		...
		const url = getCallUrl("/output/update?oid=" + oid + "&mode="+mode+"&tProg=<%=dto.getProgress()%>");
		openLayer();
...
// 				opener.loadGridData();
	...
	function gridResize9(){
		...
		//2row 15, 140
		//popup 15, 50
		AUIGrid.resize(myGridID9, ww-150, 400);
	}
</script>