...
<body style="margin: 0px 0px 0px 5px;">
	<form>
		...
		<input type="hidden" name="tProg" id="tProg" value="<%=data.getProgress()%>">
		<div id="tabs">
			<ul>
				<li>
			...
			<div id="tabs-1">
				...
				<jsp:include page="/extcore/jsp/project/task/normal.jsp">
					...
					<jsp:param value="<%=dto.getProgress()%>" name="tProg" />
				</jsp:include>
				<%
				} else if (taskType == 1) {
				%>
			...
			<div id="tabs-10">
				<iframe style="height: 800px;" src="/Windchill/plm/project/configSheetTab?oid=<%=data.getOid()%>"></iframe>
			</div>
			<div id="tabs-11">
				<iframe style="height: 800px;" src="/Windchill/plm/project/meetingTab?oid=<%=data.getOid()%>"></iframe>
			</div>
			<div id="tabs-12">
				<iframe style="height: 800px;" src="/Windchill/plm/project/historyTab?oid=<%=data.getOid()%>"></iframe>
			</div>														
		</div>
