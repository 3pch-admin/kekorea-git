...
<table class="button-table">
	<tr>
		<td class="left">
			...
			&nbsp;
			<input type="button" value="CONFIG SHEET 등록" title="CONFIG SHEET 등록" class="blue" onclick="create();">
		...
		renderer : {
			...
			jsCallback : function(rowIndex, columnIndex, value, item) {
				...
				if(oid.indexOf("WTDocument") > -1) {
					url = getCallUrl("/output/view?oid=" + oid);
				} else {
					url = getCallUrl("/configSheet/view?oid=" + oid);
				}
				popup(url);
			}
		},
