...
boolean edit = user.getName().equals(dto.getCreatorId());
%>
...
<table class="button-table">
	<tr>
		...
		<td class="right">
			...
			%>
			<input type="button" value="닫기" id="close" title="닫기" onclick="self.close();" style="background-color: navy;">
		</td>
	</tr>
</table>
<div id="tabs">
		...
		<table class="view-table">
			...
			<tr>
				...
				<td class="indent5" colspan="3">
					<textarea id="descriptionNotice" rows="5" readonly="readonly"><%=dto.getReqDescription() != null ? dto.getReqDescription() : ""%></textarea>
				</td>
			</tr>
			<tr>
...
function _delete() {
	...
	const url = getCallUrl("/requestDocument/delete?oid=" + oid);
	openLayer();
...
function modify() {
	const oid = document.getElementById("oid").value;
	const url = getCallUrl("/requestDocument/modify?oid=" + oid);
