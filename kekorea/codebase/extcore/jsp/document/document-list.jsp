			...
			<tr>
				<td valign="top">
					<jsp:include page="/extcore/jsp/common/folder-include.jsp">
						...
						<jsp:param value="655" name="height" />
					</jsp:include>
				</td>
				<td valign="top">&nbsp;</td>
				<td valign="top">
...
// 					vScrollChangeHandler(event);
			...
			function loadGridData() {
				...
				const field = ["oid","name","number","description","state","creatorOid","createdFrom","createdTo"];
			...
			function gridResizeTree(){
				...
				//4row 15, 200
				//2row 15, 140
				AUIGrid.resize(_myGridID, 228, hh-160);
			}
			function gridResizeMain(){
				...
				//4row 15, 200
				//2row 15, 140
				AUIGrid.resize(myGridID, ww-260, hh-160);
			}
			
			window.addEventListener('keydown', function(event) {
				if (event.key === 'F5') {
					event.preventDefault();
					const tab = parent.document.getElementById("tab26");
					if (tab != null) {
