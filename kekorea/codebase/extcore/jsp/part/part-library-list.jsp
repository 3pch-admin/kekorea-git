	...
	<form>
		...
		<table class="button-table">
			<tr>
				...
				<td class="right">
					<input type="button" value="부품" title="부품" style="background-color: orange;" onclick="toggle('product');">
...
// 					vScrollChangeHandler(event);
			...
			function exportExcel() {
				...
				exportToExcel("부품 라이브러리 리스트", "부품 라이브러리", "부품 라이브러리 리스트", exceptColumnFields, sessionName);
			}

			function toggle() {
				const iframe = parent.document.getElementById("content");
				iframe.src = getCallUrl("/part/list");
			}
