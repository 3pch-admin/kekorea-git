	...
	<form>
		...
		<table class="button-table">
			<tr>
				...
				<td class="right">
					...
					<input type="button" value="수정" title="수정" class="" onclick="modify();">
		...
		<script type="text/javascript">
			...
			function loadGridData() {
				...
				const field = [ "lotNo", "keNumber", "name", "code", "model", "state", "creatorOid", "createdFrom", "createdTo", "modifierOid", "modifiedFrom", "modifiedTo" ];
			...
			function modify() {
				...
				const panel = popup("/Windchill/plm/kePart/modify", 1600, 550);
				panel.list = checkedItems;
			}
			...
			window.addEventListener('keydown', function(event) {
				if (event.key === 'F5') {
					...
					const tab = parent.document.getElementById("tab25");
					if (tab != null) {
