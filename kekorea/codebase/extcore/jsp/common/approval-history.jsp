...
boolean isMargin = Boolean.parseBoolean(request.getParameter("isMargin"));
%>
<div id="grid_wrap100" style="height: 350px; border-top: 1px solid #3180c3; <%if(isMargin) {%> margin: 5px; <%}%>"></div>
