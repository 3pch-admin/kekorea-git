	...
	<form>
		...
		<table class="search-table">
			...
			<tr>
				<th>비고</th>
				<td class="indent5">
					<input type="text" name="note" id="note" class="width-200">
				</td>
				<th>작성자</th>
				<td class="indent5">
...
// 				});
			...
			function loadGridData() {
				...
				const field = [ "item", "improvements", "improvement", "apply", "mak", "detail", "customer", "install", "creatorOid", "createdFrom", "createdTo", "note" ];
			...
			window.addEventListener('keydown', function(event) {
				if (event.key === 'F5') {
					...
					const tab = parent.document.getElementById("tab36");
					if (tab != null) {
