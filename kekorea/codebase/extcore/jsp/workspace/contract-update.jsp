...
ApprovalContract contract = (ApprovalContract)request.getAttribute("contract");
ApprovalMaster appMaster = (ApprovalMaster)request.getAttribute("appMaster");
...
oid = CommonUtils.getOIDString(contract);

ApprovalLine submietLine = WorkspaceHelper.manager.getSubmitLine(appMaster);
ApprovalContractDTO appConDtto = new ApprovalContractDTO(contract);
%>
<!DOCTYPE html>
<html>
<head>
	...
	<form>
		<table class="button-table">
			<tr>
				...
				<td class="right">
					<input type="button" value="결재수정" title="결재수정" onclick="registerLine();" style="background-color: navy;">
				</td>
			</tr>
		</table>
		<table class="create-table">
			...
			<tr>
				...
				<td class="indent5">
					<input type="text" name="name" id="name" class="width-700" value="<%=appMaster==null?"":appMaster.getName()%>">
				</td>
			</tr>
			<tr>
				<th class="req lb">결재 의견</th>
				<td class="indent5">
					<textarea id="description" name="description" rows="5"><%=appConDtto.getDescription()==null?"":appConDtto.getDescription()%></textarea>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="include">
						...
						<script type="text/javascript">
							...
							function readyHandler11() {
								const data = <%=contractNumberRuleList%>
								AUIGrid.addRow(myGridID11, data);
							}
							
							function readyHandler() {
								const data = <%=contractEPMList%>
