...
<input type="hidden" name="viewType" id="viewType" value="org">
<table class="button-table">
	<tr>
		<td class="right">
			<input type="button" value="등록" title="등록" class="blue" onclick="register();">
...
<!-- 				<tr> -->
<!-- 					<td class="center"> -->
<!-- 						<input type="button" value="불러오기" title="불러오기" onclick="_load();"> -->
<!-- 					</td> -->
<!-- 				</tr> -->
			</table>
		</td>
...
function changeHandler(event) {
	...
	if(type === "org") {
		document.getElementById("viewType").value = "org";
		...
		document.getElementById("viewType").value = "user";
		...
		document.getElementById("viewType").value = "line";
		org.classList.remove("active");
		user.classList.remove("active");
...
function moveRow() {
	...
	const rows = AUIGrid.getCheckedRowItemsAll(grid);
	if (rows.length <= 0) {
		alert("선택된 사용자가 없습니다.");
		return false;
	}
