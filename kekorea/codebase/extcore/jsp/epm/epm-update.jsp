	...
	<form>
		...
		<table class="create-table">
			...
			<tr>
				...
				<td class="indent5">
					<input type="text" name="name" id="name" class="width-700" value="<%=appMaster.getName()%>">
				</td>
			</tr>
			<tr>
				<th class="req lb">결재 의견</th>
				<td class="indent5">
					<textarea id="description" name="description" rows="5"><%=WorkspaceHelper.manager.getSubmitLine(appMaster).getDescription()%></textarea>
				</td>
			</tr>
			<tr>
		...
		<script type="text/javascript">
			function registerLine() {
				const url = getCallUrl("/epm/update");
				const params = new Object();
